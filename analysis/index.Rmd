...
This website contains a number of analysis that have been performed on the KCM data, they can be found below:
...
* Combined Costs Analysis
  ...
  + [Combined Costs Analysis_20210505](combined_cost_analysis_20210503.html)
    - Manual changes to data to make merges on vehicle types better
